---
title: "Microarray Data Rspondin KO in proximal/distal colon - Reanalysis with LIMMA"
...
```{r}
ed=ed_orig
save(ed, RG, MA, file="../../Data/Processed/Rspo_KO_Colon_micro_array_preprocessed_data.Rdata")
```
