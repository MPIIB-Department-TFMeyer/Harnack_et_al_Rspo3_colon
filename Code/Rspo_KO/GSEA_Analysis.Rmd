---
title: "Microarray Data Rspo KO vs. WT in  colon - GSEA analysis on DGE results"
...
We here run GSEA on DGE results from the 44k arrays of Axin2+ vs. Axin2- cells. For analysis, a preranked analysis using the R package fGSEA is used that should give similar results to preranked analysis in standard GSEA. 
...
```{r}
data_generation_date = "2019-05-27"
